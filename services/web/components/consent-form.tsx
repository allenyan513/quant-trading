...
/**
 * The Authorize / Deny UI of the OAuth consent screen (app/oauth/consent). Posts the
 * decision to Better Auth's consent endpoint and follows the returned redirect back
 * to the client (Claude). The user reaches this already signed in.
 */
